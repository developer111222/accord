   ...
   <AboutComponent className="flex items-center justify-center w-full flex-col bg-black px-4">
    ...
    <div className="max-w-6xl bg-black mx-auto ">
     <div className="my-10 flex flex-col md:flex-row">
      ...
      <p className="text-white text-sm flex-1 p-5">Accord Cables stands out as your preferred choice due to our unwavering commitment to excellence.<br/> With a focus on superior quality and customer satisfaction, we consistently deliver<br/> reliable wiring solutions that meet the highest industry standards.</p>
    </div>
    <WhyChoose/>
