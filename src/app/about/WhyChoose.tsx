...
export function WhyChoose() {
  return (
    ...
    <GridItem
        ...
        description="Accord Cables ensures top-notch products with consistent, superior performance."
      />
      ...
      <GridItem
        ...
        description="Choose innovation that keeps your projects ahead with Accord Cables."
      />
