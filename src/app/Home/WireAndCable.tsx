...
const WireAndCable = () => {
  ...
  <div className=" bg-black w-full dark:border dark:border-white/[0.1] rounded-md">
    ...
    <h2 className='text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-100 to-neutral-300'> wire and cables</h2>
    ...
    Fireproof Your Systems with Durable PVC Cables</p>
